...
const DRAFT_RULES = `Never invent familiarity, results, budget, or intent, and never comment on industry trends. Produce every piece of copy even when contact details are unavailable. LinkedIn comment: two useful sentences replying to the actual post, with no pitch; leave empty only when the source is not a post. LinkedIn connection note: under 200 characters, specific to the evidence, no link. LinkedIn message (sent after they accept, or as an InMail): 60 to 110 words, plain, opens with the specific thing seen, one low-friction question, no meeting request, no link. Email subject: under 6 words, lowercase. Email body: under 80 words, plain text, one low-friction question, no meeting request, one link maximum. For hiring evidence, name the specific product or automation Nine-67 would build to do the job instead of hiring: what it would be (an internal tool, a data or reporting pipeline, an AI assistant, a workflow that runs itself), what it would do day to day, and which parts of the posted role it absorbs. Be concrete about the build, in plain words, not a generic pitch; offer a free one-page teardown of the role along those lines. Return JSON only: {"brief":"","why_now":"","channel":"email_first","linkedin_comment":"","linkedin_note":"","linkedin_message":"","email_subject":"","email_body":""}.`;
