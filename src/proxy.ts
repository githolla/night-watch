...
function isPublicPath(pathname: string) {
  return pathname === "/setup" || pathname.startsWith("/invite/") || pathname.startsWith("/api/auth/") || pathname.startsWith("/api/cron/") || pathname.startsWith("/api/slack/") || pathname.startsWith("/api/gmail/callback") || pathname.startsWith("/api/unsubscribe") || /\.[a-z0-9]+$/i.test(pathname);
}
