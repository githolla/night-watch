...
1. hiring (job_post or job_cluster): open roles on {careers_url} or job boards where Nine-67 would build the system instead of the company hiring a person to do the work by hand: AI/ML, automation and process improvement, data and reporting, systems and integration, CRM administration, and analyst seats in RevOps or operations. Sales reps, customer support desks and leadership hires do NOT qualify; the one exception is a leader hired specifically to build AI or automation, which is a mandate. Clusters of related roles, reposted roles, and roles open 30+ days are the strongest. Capture the exact title, department, days open, whether reposted, salary maximum if shown, tools named, and the responsibilities as written.
